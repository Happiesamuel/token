...
function Hero() {
  return (
    <section className="relative w-full min-h-[180vh] md:min-h-screen flex items-center justify-center overflow-hidden">
      <video
        autoPlay
        loop
        muted
      ...
      >
        <source src="/layout/hero.mp4" type="video/mp4" />
      ...
      <video
        ...
        muted
        playsInline
        className="absolute top-0 left-0 w-full min-h-[100vh] md:h-full object-cover md:hidden block"
      >
        <source src="/layout/heromobile.mp4" type="video/mp4" />
        Your browser does not support the video tag.
      </video>

      <div className="absolute inset-0" />

      <div className="relative z-10 flex flex-col md:flex-row md:items-center  md:justify-start w-full max-w-7xl px-6 md:px- lg:px- text-white text-center md:text-left pb-85 md:pb-0">
